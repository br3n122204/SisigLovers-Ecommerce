...
export default function FooterConditional() {
  ...
  return (
    <footer className="bg-[#A75D43] text-white font-sans mt-16">
      <div className="max-w-7xl mx-auto px-4 py-14 flex flex-col md:flex-row justify-between items-center md:items-start gap-12 md:gap-0">
        ...
        <div className="w-full md:w-1/3 text-center md:text-left mb-8 md:mb-0">
          ...
          <p className="text-[#fff9f3]">Discover the best in local streetwear. DPT ONE brings you curated collections, exclusive drops, and a seamless shopping experience right from Cebu to your doorstep.</p>
        </div>
        <div className="w-full md:w-1/3 text-center md:text-right">
          <h2 className="text-xl font-bold mb-2">Contact Us</h2>
          <div className="flex flex-col items-center md:items-end gap-1 text-[#fff9f3]">
      ...
      <div className="border-t border-[#c98a6a] text-center py-4 text-[#fff9f3] text-sm">
